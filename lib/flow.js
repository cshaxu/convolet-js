...
function setSymbolRef(flowContent, name, nodeIndex, path) {
...
var Flow = /** @class */ (function () {
    function Flow(content, nodeContents, systemEvaluator, adapter) {
        var _this = this;
        ...
        this.nodes = nodeContents
            ...
            return new node_1.Node(nodeConfig, nc, input, systemEvaluator, adapter);
        });
        this.systemEvaluator = systemEvaluator;
        this.adapter = adapter;
    }
    Flow.get = function (id, systemEvaluator, adapter) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, new Flow(content, nodeContents, systemEvaluator, adapter)];
                }
            });
        });
    };
    Flow.create = function (config, initialInput, systemEvaluator, adapter) {
        return __awaiter(this, void 0, void 0, function () {
            var content;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        content = _a.sent();
                        return [2 /*return*/, new Flow(content, [], systemEvaluator, adapter)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        node = new node_1.Node(nodeConfig, nodeContent, input, this.systemEvaluator, this.adapter);
    ...
    Flow.prototype.updateSymbols = function (node) {
        return __awaiter(this, void 0, void 0, function () {
            var outputParams, shouldUpdateMemory;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (typeof outputParams === "string") {
                            shouldUpdateMemory || (shouldUpdateMemory = setSymbolRef(this.content, outputParams, node.content.index, []));
                        }
                        else if (Array.isArray(outputParams)) {
                            outputParams.forEach(function (p) {
                                if (typeof p === "string") {
                                    shouldUpdateMemory || (shouldUpdateMemory = setSymbolRef(_this.content, p, node.content.index, [p]));
                                }
                                    ...
                                    shouldUpdateMemory || (shouldUpdateMemory = setSymbolRef(_this.content, name_1, node.content.index, pathParts));
                                }
                            });
                        }
