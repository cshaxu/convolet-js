...
var Flow = /** @class */ (function () {
    function Flow(content, nodeContents, adapter, options) {
        ...
        var jsonChatOptions = options.jsonChatOptions, streamChatOptions = options.streamChatOptions, systemEvaluator = options.systemEvaluator;
        this.nodes = nodeContents
            ...
            return new node_1.Node(nodeConfig, nc, input, adapter, systemEvaluator);
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        node = new node_1.Node(nodeConfig, nodeContent, input, this.adapter, this.systemEvaluator);
    ...
    Flow.prototype.run = function (userInput) {
        return __awaiter(this, void 0, void 0, function () {
            var currentNode, _a, nodeConfig, nodeType, nextNodeOptions, nodeStatus, _b, _c, _d, _e, _f, nextNodeKey, _g, nextNodeKey;
            var _h;
                ...
                switch (_j.label) {
                    ...
                    case 4:
                        ...
                        switch (_b) {
                            ...
                            case types_1.NodeType.BOT_EVALUATION: return [3 /*break*/, 14];
                            case types_1.NodeType.SYSTEM_EVALUATION: return [3 /*break*/, 22];
                            case types_1.NodeType.BOT_DECISION: return [3 /*break*/, 30];
                            case types_1.NodeType.SYSTEM_DECISION: return [3 /*break*/, 38];
                        }
                        return [3 /*break*/, 46];
                    case 5:
                        _c = nodeStatus;
                        switch (_c) {
                            ...
                            case types_1.NodeStatus.PROCESSING: return [3 /*break*/, 7];
                            case types_1.NodeStatus.COMPLETED: return [3 /*break*/, 10];
                        }
                        return [3 /*break*/, 12];
                    ...
                    case 9:
                        _j.sent();
                        return [3 /*break*/, 13];
                    case 10: return [4 /*yield*/, this.next(getOnlyNextNodeKey(nextNodeOptions))];
                    case 11:
                        currentNode = _j.sent();
                        return [3 /*break*/, 13];
                    case 12: throw new Error(buildContentErrorMessage(this.content, "invalid NodeStatus (".concat(nodeStatus, ")")));
                    case 13: return [3 /*break*/, 47];
                    case 14:
                        _d = nodeStatus;
                        switch (_d) {
                            case types_1.NodeStatus.INITIATED: return [3 /*break*/, 15];
                            case types_1.NodeStatus.COMPLETED: return [3 /*break*/, 18];
                        }
                        return [3 /*break*/, 20];
                    case 15: return [4 /*yield*/, currentNode.botEvaluate(this.jsonChatOptions)];
                    case 16:
                        _j.sent();
                        return [4 /*yield*/, this.updateSymbols(currentNode)];
                    case 17:
                    ...
                    case 18:
                        if (nodeConfig.nextNodeOptions.length === 0) {
                            return [2 /*return*/, currentNode.content.output];
                        }
                        return [4 /*yield*/, this.next(getOnlyNextNodeKey(nextNodeOptions))];
                    case 19:
                        currentNode = _j.sent();
                        return [3 /*break*/, 21];
                    case 20: throw new Error(buildContentErrorMessage(this.content, "invalid NodeStatus (".concat(nodeStatus, ")")));
                    case 21: return [3 /*break*/, 47];
                    case 22:
                        _e = nodeStatus;
                        switch (_e) {
                            case types_1.NodeStatus.INITIATED: return [3 /*break*/, 23];
                            case types_1.NodeStatus.COMPLETED: return [3 /*break*/, 26];
                        }
                        return [3 /*break*/, 28];
                    case 23: return [4 /*yield*/, currentNode.systemEvaluate()];
                    case 24:
                        _j.sent();
                        return [4 /*yield*/, this.updateSymbols(currentNode)];
                    case 25:
                    ...
                    case 27:
                        currentNode = _j.sent();
                        return [3 /*break*/, 29];
                    case 28: throw new Error(buildContentErrorMessage(this.content, "invalid NodeStatus (".concat(nodeStatus, ")")));
                    case 29: return [3 /*break*/, 47];
                    case 30:
                        _f = nodeStatus;
                        switch (_f) {
                            case types_1.NodeStatus.INITIATED: return [3 /*break*/, 31];
                            case types_1.NodeStatus.COMPLETED: return [3 /*break*/, 34];
                        }
                        return [3 /*break*/, 36];
                    case 31: return [4 /*yield*/, currentNode.botDecide(this.jsonChatOptions)];
                    case 32:
                        _j.sent();
                        return [4 /*yield*/, this.updateSymbols(currentNode)];
                    case 33:
                    ...
                    case 35:
                        currentNode = _j.sent();
                        return [3 /*break*/, 37];
                    case 36: throw new Error(buildContentErrorMessage(this.content, "invalid NodeStatus (".concat(nodeStatus, ")")));
                    case 37: return [3 /*break*/, 47];
                    case 38:
                        _g = nodeStatus;
                        switch (_g) {
                            case types_1.NodeStatus.INITIATED: return [3 /*break*/, 39];
                            case types_1.NodeStatus.COMPLETED: return [3 /*break*/, 42];
                        }
                        return [3 /*break*/, 44];
                    case 39: return [4 /*yield*/, currentNode.systemDecide()];
                    case 40:
                        _j.sent();
                        return [4 /*yield*/, this.updateSymbols(currentNode)];
                    case 41:
                    ...
                    case 43:
                        currentNode = _j.sent();
                        return [3 /*break*/, 45];
                    case 44: throw new Error(buildContentErrorMessage(this.content, "invalid NodeStatus (".concat(nodeStatus, ")")));
                    case 45: return [3 /*break*/, 47];
                    case 46: throw new Error(buildContentErrorMessage(this.content, "invalid NodeType (".concat(nodeType, ")")));
                    case 47:
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (currentNode === undefined) {
                            throw new Error(buildContentErrorMessage(this.content, "flow is not started yet"));
                        }
