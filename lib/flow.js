...
var Flow = /** @class */ (function () {
    function Flow(content, nodeContents, executor, adapter) {
        ...
        this.nodes = nodeContents
            ...
            .map(function (nc) {
            return new node_1.Node(nodeConfigByNodeKey.get(nc.key), nc, null, executor, adapter);
        });
        this.nodes
            .filter(function (_, i) { return i > 0; })
            .forEach(function (node, i) { return (node.previous = _this.nodes.at(i - 1)); });
    ...
    Flow.prototype.next = function (nodeKey) {
        return __awaiter(this, void 0, void 0, function () {
            var nodeConfig, nodeContent, previousNode, node;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        node = new node_1.Node(nodeConfig, nodeContent, previousNode, this.executor, this.adapter);
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 13:
                        _f.sent();
                        return [3 /*break*/, 16];
                    case 14: return [4 /*yield*/, currentNode.completeExecution()];
                    case 15:
                        _f.sent();
                        return [3 /*break*/, 16];
