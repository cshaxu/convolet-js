...
function getVariable(param, nodeContentByIndex, memory) {
    var _a;
    ...
    return path.reduce((a, p) => (a === undefined ? undefined : a[p]), input);
}
function buildNodeInput(flowContent, index, nodeContentByIndex, nodeConfigByNodeKey, memory) {
    ...
    if (currentNodeConfig === undefined) {
        new Error(buildContentErrorMessage(flowContent, `missing NodeConfig (${currentNodeContent.key})`));
        return {};
    }
    // retrieve
...
class Flow {
    ...
    constructor(content, nodeContents, adapter, options) {
        ...
        const nodeConfigByNodeKey = (0, utils_1.toObjectMap)(this.content.config.nodes, (nc) => nc.nodeKey);
        const nodeContentByIndex = (0, utils_1.toObjectMap)(nodeContents, (nc) => nc.index);
        ...
        this.nodes = nodeContents
            ...
            const input = buildNodeInput(content, nc.index, nodeContentByIndex, nodeConfigByNodeKey, this.content.memory);
    ...
    next(nodeKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const nodeContentByIndex = (0, utils_1.toObjectMap)(nodeContents, (nc) => nc.index);
            const input = buildNodeInput(this.content, nodeContent.index, nodeContentByIndex, nodeConfigByNodeKey, this.content.memory);
    ...
    step(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentNode = (_a = getLastItem(this.nodes)) !== null && _a !== void 0 ? _a : (yield this.start());
