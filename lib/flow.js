...
function validateFlowConfig(flowConfig) {
    ...
    nodes.forEach(function (nodeConfig) {
        ...
        nextNodeOptions.forEach(function (nno) {
            var inputNodeConfig = nodes.find(function (nc) { return nc.nodeKey === nno.nodeKey; });
            if (inputNodeConfig === undefined && nno.nodeKey !== "initial") {
                throwError(flowKey, "NodeConfig (".concat(nodeKey, "): missing input NodeConfig (").concat(nno.nodeKey, ")"));
            }
        });
        switch (nodeType) {
            case types_1.NodeType.INTERACTION:
                ...
                var nextNodeConfig = nodes.find(function (nc) { return nc.nodeKey === nextNodeOptions[0].nodeKey; });
                if (nextNodeConfig === undefined) {
                    throwError(flowKey, "NodeConfig (".concat(nodeKey, "): missing next NodeConfig (").concat(nextNodeOptions[0].nodeKey, ")"));
                }
                break;
...
function buildInput(flowId, index, nodeContentByIndex, nodeConfigByNodeKey, memory) {
    ...
    return currentConfig.inputParams.reduce(function (acc, param) {
        ...
        var inputNodeIndex = memory.symbols[param];
        var inputNode = nodeContentByIndex.get(inputNodeIndex);
        var input = (_a = inputNode === null || inputNode === void 0 ? void 0 : inputNode.output) !== null && _a !== void 0 ? _a : null;
        if (input !== null) {
            acc[param] = input;
        }
        return acc;
...
var Flow = /** @class */ (function () {
    ...
    Flow.prototype.save = function (node) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Flow.prototype.run = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var userInput, streamChatOptions, jsonChatOptions, currentNode, _a, nodeConfig, nodeType, nodeStatus, _b, _c, messages, _d, _e, _f, nextNodeKey, _g, nextNodeKey;
            var _h;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 9:
                        _j.sent();
                        return [4 /*yield*/, this.save(currentNode)];
                    case 10:
                        _j.sent();
                        return [3 /*break*/, 14];
                    case 11: return [4 /*yield*/, this.next(nodeConfig.nextNodeOptions[0].nodeKey)];
                    case 12:
                        currentNode = _j.sent();
                        return [3 /*break*/, 14];
                    ...
                    case 19:
                        ...
                        return [4 /*yield*/, this.next(nodeConfig.nextNodeOptions[0].nodeKey)];
                    case 20:
                        currentNode = _j.sent();
                        return [3 /*break*/, 22];
