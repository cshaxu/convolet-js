...
var Node = /** @class */ (function () {
    function Node(config, content, input, systemEvaluator, adapter) {
        this.config = config;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        // evaluate
                        _a = this.content;
                        if (!(this.systemEvaluator === null)) return [3 /*break*/, 1];
                        _b = {};
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 6];
                    case 2:
                        if (!(this.systemEvaluator !== null && nextNodeOptions.length > 1)) return [3 /*break*/, 4];
