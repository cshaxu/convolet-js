...
var Node = /** @class */ (function () {
    function Node(config, content, previous, executor, adapter) {
        this.config = config;
    ...
    Node.prototype.generateStream = function (initialInput, messages, options) {
        return __awaiter(this, void 0, void 0, function () {
            var input, _a, prompt, nextNodeOptions, fullStreamPrompt, onStreamDone;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        input = this.previous === null ? initialInput : this.previous.content.output;
                        _a = this.config, prompt = _a.prompt, nextNodeOptions = _a.nextNodeOptions;
                        fullStreamPrompt = (0, prompts_1.buildFullStreamPrompt)(prompt, messages.length > 0, input);
    ...
    Node.prototype.generateJson = function (initialInput, jsonChatOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var input, _a, prompt, schema, nextNodeOptions, fullJsonPrompt, jsonPromise, fullNextNodeKeyPrompt, nextNodeKeyPromise, _b, output, nextNodeKey;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        fullJsonPrompt = (0, prompts_1.buildFullJsonPrompt)(prompt, input);
                        jsonPromise = this.adapter.jsonChat(fullJsonPrompt, schema !== null && schema !== void 0 ? schema : "{}", jsonChatOptions);
                        fullNextNodeKeyPrompt = (0, prompts_1.buildFullNextNodeKeyPrompt)(nextNodeOptions, input);
                        nextNodeKeyPromise = nextNodeOptions.length > 1
                            ? this.adapter
    ...
    Node.prototype.completeExecution = function () {
        return __awaiter(this, void 0, void 0, function () {
