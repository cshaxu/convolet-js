...
function buildErrorMessage(content, fieldName, expected, got) {
    var objectId = [content.key, content.flowId, content.index].join("-");
    return "Node (".concat(objectId, "): \"").concat(fieldName, "\", expected \"").concat(expected.toString(), "\", got \"").concat(got.toString(), "\"");
}
var Node = /** @class */ (function () {
    function Node(config, content, input, adapter, promptBuilders, systemEvaluator) {
        this.config = config;
    ...
    Node.prototype.interactBotStream = function (messages, onStreamDone, options) {
        return __awaiter(this, void 0, void 0, function () {
            var prompt, botStreamPrompt, callback;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        botStreamPrompt = this.promptBuilders.botStream(prompt, messages.length > 0, this.input);
                        callback = function (generated) { return __awaiter(_this, void 0, void 0, function () {
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        _b.sent();
                                        return [4 /*yield*/, onStreamDone(generated)];
                                    case 2:
                                        _b.sent();
                                        return [2 /*return*/];
                                }
                        ...
                        return [4 /*yield*/, this.adapter.streamChat(botStreamPrompt, messages, callback, options)];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = this.content;
                        return [4 /*yield*/, this.adapter.jsonChat(this.promptBuilders.botEvaluation(prompt, this.input), schema, jsonChatOptions)];
                    case 1:
                        _b.output = _c.sent();
                        // persist
                        return [4 /*yield*/, this.adapter.updateNode(this.content)];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        // evaluate
                        _a = this.content;
                        if (!(this.systemEvaluator === undefined)) return [3 /*break*/, 1];
                        _b = {};
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.systemEvaluator(this.input, this.content, this.config)];
                    case 2:
                        _b = _c.sent();
                        _c.label = 3;
                    case 3:
    ...
    Node.prototype.botDecide = function (jsonChatOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var nextNodeOptions, promptedNextNodeOptions, botDecisionPrompt, _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        botDecisionPrompt = this.promptBuilders.botDecision(promptedNextNodeOptions, this.input);
                        _a = this.content;
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.adapter.jsonChat(botDecisionPrompt, "{ nextNodeKey: string, reason: string }", jsonChatOptions)];
                    case 3:
                        _d = _e.sent();
                        return [3 /*break*/, 5];
                    case 4:
                        _d = { nextNodeKey: "invalid nextNodeOptions" };
                        _e.label = 5;
                    case 5:
                        _c = _d;
                        _e.label = 6;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 6];
                    case 2:
                        if (!(this.systemEvaluator !== undefined && nextNodeOptions.length > 1)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.systemEvaluator(this.input, this.content, this.config)];
                    case 3:
                        _d = _e.sent();
                        return [3 /*break*/, 5];
                    case 4:
                        _d = { nextNodeKey: "invald nextNodeOptions or systemEvaluator" };
                        _e.label = 5;
                    case 5:
                        _c = _d;
                        _e.label = 6;
