...
var Node = /** @class */ (function () {
    ...
    Node.prototype.botDecide = function (jsonChatOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var nextNodeOptions, fullNextNodeKeyPrompt, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        fullNextNodeKeyPrompt = (0, prompts_1.buildFullNextNodeKeyPrompt)(nextNodeOptions, this.input);
                        _a = this.content;
                        if (!(nextNodeOptions.length === 1)) return [3 /*break*/, 1];
                        _b = { nextNodeKey: nextNodeOptions[0].nodeKey };
                        return [3 /*break*/, 5];
                    case 1:
                        if (!(nextNodeOptions.length > 1)) return [3 /*break*/, 3];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 5];
                    case 1:
                        if (!(this.executor !== null && nextNodeOptions.length > 1)) return [3 /*break*/, 3];
