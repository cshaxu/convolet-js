...
var Node = /** @class */ (function () {
    function Node(config, content, input, adapter, systemEvaluator) {
        this.config = config;
    ...
    Node.prototype.interactBotStream = function (messages, onStreamDone, options) {
        return __awaiter(this, void 0, void 0, function () {
            var prompt, fullStreamPrompt, callback;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.adapter.streamChat(fullStreamPrompt, messages, callback, options)];
