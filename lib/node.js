...
var Node = /** @class */ (function () {
    ...
    Node.prototype.generateJson = function (initialInput, jsonChatOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var input, _a, prompt, schema, nextNodeOptions, jsonPromise, fullNextNodeKeyPrompt, nextNodeKeyPromise, _b, output, nextNodeKey;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        jsonPromise = prompt === null || schema === null
                            ? Promise.resolve({})
                            : this.adapter.jsonChat((0, prompts_1.buildFullJsonPrompt)(prompt, input), schema, jsonChatOptions);
